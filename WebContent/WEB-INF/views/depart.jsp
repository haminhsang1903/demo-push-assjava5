	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<form:form action="formDepart.htm" modelAttribute="depart"
					method="POST">
					<div class="col-md-12">
						<div class="row">
				...
				<br /> <br />
				<section class="alt">
					<form method="get" action="formDepart.htm">
						<div class="col-md-12">
							<div class="row">
				...
				<section>
					...
					<table>
						...
						<tbody>
							...
							<c:forEach var="r" items="${getDepart }">
								<form:form action="tableDepart.htm" method="post">
									<tr>
										<td>${r.id }</td>
										<td>${r.name }</td>
										<td><button name="btn-edit">Edit</button> <input
											type="hidden" name="id-info" value="${r.id }" /></td>
									</tr>
								</form:form>
							</c:forEach>
